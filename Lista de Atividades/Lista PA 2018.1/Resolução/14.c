/*14 - Leia uma data de nascimento de uma pessoa fornecida através de três números inteiros:
...
validade do mês: mês > 0 e mês < 13. Teste a validade do ano: ano = ano atual (use uma
constante definida com o valor igual a 2008). Imprimir: “data valida” ou “data invalida” no final
